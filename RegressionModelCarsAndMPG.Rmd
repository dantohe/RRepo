...
We pick a few variables and look for correlations between them. We are mostly into correlations with MPGs.

```{r}

cp1 = ggpairs(mtcars, columns =c("mpg","cyl","am"),columnLabels = c("MPG", "Num.of Cylinders","Transmission"), lower = list(
